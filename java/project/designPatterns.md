> 本文由 [简悦 SimpRead](http://ksria.com/simpread/) 转码， 原文地址 https://juejin.im/post/5bc96afff265da0aa94a4493

设计模式是对大家实际工作中写的各种代码进行高层次抽象的总结，我们将设计模式分类为 23 种经典的模式，根据用途我们又可以分为三大类，分别为创建型模式、结构型模式和行为型模式。是的，我不善于扯这些有的没的，还是少点废话吧~~~
...
![image-20190726154831765](../../assets/image-20190726154831765.png)
...
![image-20190726154920508](../../assets/image-20190726154920508.png)
...
![image-20190726155109499](../../assets/image-20190726155109499.png)

当涉及到这种产品族的问题的时候，就需要抽象工厂模式来支持了。我们不再定义 CPU 工厂、主板工厂、硬盘工厂、显示屏工厂等等，我们直接定义电脑工厂，每个电脑工厂负责生产所有的设备，这样能保证肯定不存在兼容问题。

![image-20190726155132348](../../assets/image-20190726155132348.png)
...
// TODO 另外一种用法是抽象工厂代表对工厂的抽象，实现诸如：ComputerFactory.makeComputer("intel");
```
...
![image-20190726162307878](../../assets/image-20190726162307878.png)
...
![image-20190726162837212](../../assets/image-20190726162837212.png)
...
![image-20190726162857251](../../assets/image-20190726162857251.png)
...
![image-20190726172032587](../../assets/image-20190726172032587.png)

这回大家应该就知道抽象在哪里，怎么解耦了吧。桥梁模式的优点也是显而易见的，就是非常容易进行扩展。

> 本节引用了[这里](https://link.juejin.im?target=https%3A%2F%2Fwww.tutorialspoint.com%2Fdesign_pattern%2Fbridge_pattern.htm)的例子，并对其进行了修改。
...
![image-20190726172236747](../../assets/image-20190726172236747.png)
...
都可以作为 Component 来使用，因为它们都实现了 Component 中的所有接口。它们和 Component 实现类 ConcreteComponent的区别是，它们只是装饰者，起**装饰**作用，也就是即使它们看上去牛逼轰轰，但是它们都只是在具体的实现中**加了层皮来装饰**而已。
...
![image-20190726173015066](../../assets/image-20190726173015066.png)

到这里，大家应该已经清楚装饰模式了吧。

下面，我们再来说说 java IO 中的装饰模式。看下图 InputStream 派生出来的部分类：

![image-20190726173045492](../../assets/image-20190726173045492.png)
...
![image-20190726174059716](../../assets/image-20190726174059716.png)

这个时候，大家有没有联想到结构型模式中的桥梁模式，它们其实非常相似，我把桥梁模式的图拿过来大家对比下：

![image-20190726174130840](../../assets/image-20190726174130840.png)
